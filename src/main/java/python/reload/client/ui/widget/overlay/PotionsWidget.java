...
public class PotionsWidget extends Widget {
    ...
    public void render(MatrixStack matrixStack) {
        ...
        float totalHeight = bgHeight * (effectList.size() + 1) + lineSpacing * effectList.size();
        ...
        for (StatusEffectInstance effect : effectList) {
            ...
            font.drawText(matrixStack, name, currentX, textY, fontSize, new Color(effectColor.getRed(), effectColor.getGreen(), effectColor.getBlue(), (int)(effectColor.getAlpha() * animValue)));
            ...
            font.drawText(matrixStack, durationText, bgX + bgWidth - padding - font.getWidth(durationText, fontSize), textY, fontSize, new Color(durationColor.getRed(), durationColor.getGreen(), durationColor.getBlue(), (int)(durationColor.getAlpha() * animValue)));
            currentY += bgHeight + lineSpacing;
        }
