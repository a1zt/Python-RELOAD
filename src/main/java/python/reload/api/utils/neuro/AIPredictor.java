package python.reload.api.utils.neuro;
...
import python.reload.api.utils.animation.wrap.infinity.RotationAnimation;
...
import python.reload.api.utils.rotation.rotations.SpookyTimeRotation;
...
//        float targetPitch = predictedPitch + pitchDiff - interpolation.getPitch();
        ...
        if (PlayerUtil.hasCollisionWith(target) && (SpookyTimeRotation.stalin(target) || PlayerUtil.getBlock(0, 2, 0) != Blocks.AIR && PlayerUtil.getBlock(0, -1, 0) != Blocks.AIR && PlayerUtil.getBlock(0, 2, 0) != Blocks.WATER && PlayerUtil.getBlock(0, -1, 0) != Blocks.WATER) || PlayerUtil.hasCollisionWith(target, -0.7f)) {
