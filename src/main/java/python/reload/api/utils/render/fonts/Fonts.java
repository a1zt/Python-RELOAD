...
public class Fonts {
    ...
    public final Font ICON_V1 = get("other/icon");
    public final Font ICON_DESHUX = get("other/icon_deshux");
    public final Font ICON_ESSENS = get("other/icoes");
    ...
    public final Font ICONS = get("other/icoes");
